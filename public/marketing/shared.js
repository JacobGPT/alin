...
function initPlayground(){
  ...
  const responses=[
    ...
    {match:['logo','image','generate'],steps:['Crafting FLUX.2 prompt...','Generating 3 variations...','Uploading to CDN...'],reply:'3 logo variations ready on CDN. Each in 1024×1024 with transparent background. Want refinements?'},

...
const TIER_CONFIGS = {
  standard: {
    ...
    imageProvider:   'auto',
    imageMultiple:   false,
    primaryCode:     { model: 'claude-sonnet-4-6', provider: 'anthropic' },
  ...
  premium: {
    ...
    design:          { model: 'claude-sonnet-4-6', provider: 'anthropic' },
    ...
    repair:          { model: 'claude-sonnet-4-6', provider: 'anthropic' },
  ...
  ultra: {
    ...
    imageMultiple:   true,
    primaryCode:     { model: 'claude-sonnet-4-6', provider: 'anthropic' },
    secondaryCode:   { model: 'claude-sonnet-4-6', provider: 'anthropic' },
    codeReview:      { model: 'deepseek-reasoner',          provider: 'deepseek'  },
